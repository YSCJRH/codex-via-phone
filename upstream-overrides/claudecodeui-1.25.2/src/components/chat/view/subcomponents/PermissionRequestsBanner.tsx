          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                {request.message && (
                  <div className="mt-1 max-w-2xl whitespace-pre-wrap text-xs text-amber-800 dark:text-amber-200">
                    {request.message}
                  </div>
                )}
              </div>
              <div className="space-y-1 text-right">
                <div className="inline-flex rounded-full border border-amber-300 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-amber-700 dark:border-amber-700 dark:text-amber-200">
                  {providerLabel}
                </div>
