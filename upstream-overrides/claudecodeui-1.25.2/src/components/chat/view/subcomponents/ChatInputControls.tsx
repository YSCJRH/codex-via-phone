    ...
    <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          />
          <span>
            {effectivePermissionMode === 'default' && t('codex.modes.default')}
            {effectivePermissionMode === 'acceptEdits' && t('codex.modes.acceptEdits')}
            {effectivePermissionMode === 'plan' && t('codex.modes.plan')}
          </span>
        </div>
      </button>
