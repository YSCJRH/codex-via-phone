  ...
  try {
    ...
    sdkOptions.canUseTool = async (toolName, input, context) => {
      ...
      const interaction = registerPendingInteraction({
        id: requestId,
        provider: 'claude',
        kind: requiresInteraction ? 'question' : 'permission',
        toolName,
        title: requiresInteraction ? 'Question requires review' : 'Permission required',
        input,
        context,
        sessionId: currentSessionId,
        resolutionMode: requiresInteraction ? 'question' : 'approve-deny',
        receivedAt: new Date(),
        metadata: {
          provider: 'claude',
        },
...
function getPendingApprovalsForSession(sessionId) {
  return listPendingInteractionsForSession(sessionId, { provider: 'claude' });
}
