...
import { FORBIDDEN_WORKSPACE_PATHS } from '../project-path-rules.js';
...
export const FORBIDDEN_PATHS = FORBIDDEN_WORKSPACE_PATHS;
...
router.post('/create-workspace', async (req, res) => {
  if (CODEX_ONLY_HARDENED_MODE) {
    return blockDisabledFeature(res, 'Workspace creation');
  }
...
router.get('/clone-progress', async (req, res) => {
  if (CODEX_ONLY_HARDENED_MODE) {
    return blockDisabledFeature(res, 'Workspace cloning');
  }
